 ...
 * generated in the org.huahsin.async package. 
...
public class ObjectFactory {
    ...
    private final static QName _SayHelloWorld_QNAME = new QName("http://webmethod.huahsin.org/", "sayHelloWorld");
    private final static QName _SayHelloWorldResponse_QNAME = new QName("http://webmethod.huahsin.org/", "sayHelloWorldResponse");

    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: org.huahsin.async
     * 
     */
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://webmethod.huahsin.org/", name = "sayHelloWorld")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://webmethod.huahsin.org/", name = "sayHelloWorldResponse")
