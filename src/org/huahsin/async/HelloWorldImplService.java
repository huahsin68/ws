 ...
 * 
 */
@WebServiceClient(name = "HelloWorldImplService", targetNamespace = "http://webmethod.huahsin.org/", wsdlLocation = "http://localhost:8080/ws1?wsdl")
    ...
    extends Service
{
    ...
    private final static QName HELLOWORLDIMPLSERVICE_QNAME = new QName("http://webmethod.huahsin.org/", "HelloWorldImplService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("http://localhost:8080/ws1?wsdl");
    ...
    public IHelloWorld getHelloWorldImplPort() {
        return super.getPort(new QName("http://webmethod.huahsin.org/", "HelloWorldImplPort"), IHelloWorld.class);
    }
    ...
    public IHelloWorld getHelloWorldImplPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://webmethod.huahsin.org/", "HelloWorldImplPort"), IHelloWorld.class, features);
    }
